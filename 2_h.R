...
cat("For alpha = 0.01 we reject H0 is mu > ", qnorm(1 - alpha1, mean = mean(z), sd = sd(z), lower.tail = TRUE, log.p = FALSE))
cat("For alpha = 0.05 we reject H0 is mu > ", qnorm(1 - alpha2, mean = mean(z), sd = sd(z), lower.tail = TRUE, log.p = FALSE))
cat("For alpha = 0.10 we reject H0 is mu > ", qnorm(1 - alpha3, mean = mean(z), sd = sd(z), lower.tail = TRUE, log.p = FALSE))
